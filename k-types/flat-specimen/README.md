...
A flat, sheet-type test specimen with a dog-bone or rectangular geometry. Typically
prepared from sheet or plate material and used in tensile, fatigue, or bending tests.
...
Custom properties: gauge length, gauge width, shoulder radius.
