...
Custom properties: name, manufacturer, type, serial number, inventory number, room number,
measurement range.
Semantic schema: `measurement-device/PMDCo` for a machine-readable device description.
